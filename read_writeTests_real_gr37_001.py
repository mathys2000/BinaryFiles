...
class read_writeTests_real_gr37_001(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "read_writeTests_real_gr37_001")
        ...
        self.blocks_throttle_0_1_0 = blocks.throttle(gr.sizeof_float*1, Fs13,True)
        self.blocks_throttle_0_1 = blocks.throttle(gr.sizeof_float*1, Fs12,True)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, 'sig_x2t_float32_Fs32000.bin', True)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(Fs13, analog.GR_TRI_WAVE, 100, 1, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(Fs12, analog.GR_COS_WAVE, 1000, 1, 0)
...
def main(top_block_cls=read_writeTests_real_gr37_001, options=None):
